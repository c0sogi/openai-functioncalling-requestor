...
from ...utils.function_calling.parser import parse_function_call_from_function
...
class FunctionCallsMetaClass(type):
    ...
    def __init__(cls, name, bases, dct):
        ...
        for func in cls.__dict__.values():
            if callable(func) and not func.__name__.startswith("_"):
                print("- Parsing function for function calling:", func.__name__)
    ...
    def get_function_call(cls, function: Callable) -> FunctionCall:
        ...
        if function.__name__ not in cls.function_calls:
            cls.function_calls[function.__name__] = parse_function_call_from_function(
                function
            )
